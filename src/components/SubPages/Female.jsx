...
import Carousel from "../Carousel-Slide/Carousel";
import Planning from "../Carousel-Slide/Planning";
...
function Female() {
      ...
      const go = useNavigate();
        ...
        const [isOpen, setIsOpen] = useState(false); // function : to open the slide profile
    ...
    <div className='color-f'>
     <nav className="nav-f">
      <div className="bar-f">
        ...
        <div className={`panel ${isOpen ? 'open' : ''}`}>  {/* change the classname in order to open the panel */}
        ...
        <div ref={trainingSection} onClick={checkAndGo} className='work-f'>
            <p>Training Categories</p>  {/* going to the workout page */}
        </div>
        <div>
        ...
        <Carousel />  {/* it is the workout categories in carousel */}
        <div>
        ...
        <div>
            ...
            <Planning />       {/* the coachs planning (j ai pas fait leur planning mais rani nkhemem f une solution meilleure) */}
